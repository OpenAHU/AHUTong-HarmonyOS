...
> [!IMPORTANT]
> 项目正在持续迁移与联调，主要校园业务、工具和课前提醒已具备 HarmonyOS 实现，但真实账号、支付、服务卡片及发布签名仍需完成验收。迁移进度、架构映射、验收标准和更新记录统一维护在[迁移文档](docs/MIGRATION.md)中。
...
| 设置与系统能力 | 设置偏好和课前系统提醒已迁移；服务卡片与发布准备待完成 |
