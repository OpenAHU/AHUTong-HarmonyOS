...
> [!IMPORTANT]
> 项目正在持续迁移与联调，主要校园业务、工具、课前提醒、课表服务卡片和应用更新已具备 HarmonyOS 实现，但真实账号、支付及发布签名仍需完成验收。迁移进度、架构映射、验收标准和更新记录统一维护在[迁移文档](docs/MIGRATION.md)中。
...
| 设置与系统能力 | 设置偏好、课前系统提醒、课表服务卡片和发行版更新检查已迁移；发布准备待完成 |
